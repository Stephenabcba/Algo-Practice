...
"""
My solution: Find the largest and second largest values in nums

To maximize the product, find the 2 largest values in nums, and multiply them together after
